...
## Administration
There are 2 services: watchcat_tick_controller.service and watchcat_main.service. Services can be restarted via:
....
sudo systemctl restart watchcat_main.service watchcat_tick_controller.service
....
